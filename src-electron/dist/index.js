...
electron_1.ipcMain.on("dirDialog", function (event) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, electron_1.dialog.showOpenDialog(electron_1.BrowserWindow.fromWebContents(event.sender), {
...
electron_1.ipcMain.on("testPerformance", function (event) {
    var p0 = 0;
    var p1 = 0;
    p0 = performance.now();
    var winSender = electron_1.BrowserWindow.fromWebContents(event.sender);
    p1 = performance.now();
    console.log(p1 - p0 + "ms");
    console.log(" // ");
    p0 = performance.now();
    var winFocused = electron_1.BrowserWindow.getFocusedWindow();
    p1 = performance.now();
    console.log(p1 - p0 + "ms");
});
